...
fun main() {
    ...
    val v2 = 80
    val weight2 = 50
    println("Груз с весом $weight2 кг и объемом $v2 л соответствует категории 'Average': ${(weight2 < WEIGHT_MAX && weight2 >= WEIGHT_MIN) && v2 < V_MAX}")

    val v3 = 100
    println("Груз с весом $v3 л соответствует категории 'Average': ${v3 < V_MAX}")
}